...
function renderEasyCard() {
    ...
    (0,_timer__WEBPACK_IMPORTED_MODULE_1__.timeEasy)();
    (0,_timer__WEBPACK_IMPORTED_MODULE_1__.timeGame)();
}
...
function renderMediumCard() {
    ...
    (0,_timer__WEBPACK_IMPORTED_MODULE_1__.timeMedium)();
}
...
function renderHardCard() {
    ...
    (0,_timer__WEBPACK_IMPORTED_MODULE_1__.timeHard)();
}
...
/* harmony export */   timeEasy: () => (/* binding */ timeEasy),
/* harmony export */   timeGame: () => (/* binding */ timeGame),
/* harmony export */   timeHard: () => (/* binding */ timeHard),
/* harmony export */   timeMedium: () => (/* binding */ timeMedium)
/* harmony export */ });
/* harmony import */ var _result_game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./result-game */ "./result-game.ts");
...
/* Подумать */
// export function timeEasy(time: number) {}
//timeEasy(30);
//timeEasy(150);
function timeEasy() {
    var time = 30;
...
function timeGame() {
    var time = 0;
    /* TODO */
    var timerDownEl = document.getElementById("timerGame");
    var timer = setInterval(function () {
        var minutes = Math.floor(time / 60);
        /* TODO */
        var seconds = time % 60;
    ...
    timerDownEl.style.display = "none";
}
